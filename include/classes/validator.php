 ...
 * A collection of functions for validationg user input, with validation rules similar to CodeIgnitor/Rails.
 * Thanks to Peter (peter@osticket.com) for some of the validation rules.
 */
