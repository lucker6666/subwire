...
ActiveRecord::Schema.define(:version => 20130930070211) do
  ...
  add_index "wikis", ["channel_id"], :name => "index_pages_on_channel_id"
  add_index "wikis", ["user_id"], :name => "index_pages_on_user_id"
